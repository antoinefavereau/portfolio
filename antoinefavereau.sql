...
(18, 9, 'html_code', '<section>\r\n    <h2>Les différents composants du Système d\'Information</h2>\r\n    <p>\r\n        Un système d’information est l\'ensemble des outils et moyens pour collecter, stocker, traiter et\r\n        traiter\r\n        l\'information. Le SI repose sur un socle :\r\n    <ul>\r\n        <li>technique (gestion de l\'infrastructure et architecture informatique, c\'est-à-dire les serveurs\r\n            pour\r\n            les\r\n            réseaux informatique, les ordinateurs et postes de travail...),</li>\r\n        <li>applicatif (les logiciels informatiques : erp, crm, bases de données, applications web),</li>\r\n        <li>organisationnel (gestion des règles, des utilisateurs, de l\'infogérance pour le support, etc.).\r\n        </li>\r\n    </ul>\r\n    </p>\r\n</section>\r\n<section>\r\n    <h2>Le rôle de PowerShell dans un système de type Windows Server</h2>\r\n    <p>\r\n        PowerShell est une solution multiplateforme d’automatisation des tâches, composée d’un interpréteur\r\n        de\r\n        commandes (shell), d’un langage de script et d’un framework de gestion de la configuration.\r\n        PowerShell\r\n        s’exécute sur Windows, Linux et macOS.\r\n        La nature extensible de PowerShell a permis à un écosystème de modules PowerShell de déployer et de\r\n        gérer\r\n        quasiment toutes les technologies comme Windows.\r\n        PowerShell peut être utilisé pour administrer, maintenir, configurer et développer de nouvelles\r\n        fonctionnalités pour Windows Server.\r\n    </p>\r\n</section>\r\n<section>\r\n    <h2>Schématiser le Système d\'Information à l\'aide d\'un logiciel adapté</h2>\r\n    <p>\r\n        Le scan de ports réseaux ou balayage de ports est une méthode qui consiste à énumérer les ports\r\n        ouverts\r\n        ou\r\n        actifs d’une cible.\r\n        Le but est surtout de lister les ports ouverts afin de connaître les applications et services en\r\n        cours\r\n        de\r\n        fonctionnement.\r\n\r\n        Il existe de multiples applications sur Linux et Windows pour effectuer des balayages de ports\r\n        réseaux.\r\n    <ul>\r\n        <li>Advanced IP Scanner pour Windows :\r\n            Permet d’énumérer très facilement les machines et hôtes d’un réseau LAN.\r\n            On obtient donc la liste des hôtes avec leurs adresses IP et adresse MAC.</li>\r\n\r\n        <li>Nmap pour Windows et Linux :\r\n            Utilitaire le plus connus et renommé qui existe en ligne de commandes ou avec une interface\r\n            graphique.\r\n            Nmap\r\n            propose beaucoup d’options pour scanner un seul port ou encore jouer sur le mode de connexion ou\r\n            protocole\r\n            pour contourner des filtrages des firewall.</li>\r\n    </ul>\r\n    </p>\r\n</section>'),
...
(32, 9, 'description', 'Cours d\'introduction sur le système d\'information.'),
(33, 9, '_description', 'field_633c433336136'),
(34, 20, 'html_code', '            <section>\r\n                <h2>Les différents composants du Système d\'Information</h2>\r\n                <p>\r\n                    Un système d’information est l\'ensemble des outils et moyens pour collecter, stocker, traiter et\r\n                    traiter\r\n                    l\'information. Le SI repose sur un socle :\r\n                <ul>\r\n                    <li>technique (gestion de l\'infrastructure et architecture informatique, c\'est-à-dire les serveurs\r\n                        pour\r\n                        les\r\n                        réseaux informatique, les ordinateurs et postes de travail...),</li>\r\n                    <li>applicatif (les logiciels informatiques : erp, crm, bases de données, applications web),</li>\r\n                    <li>organisationnel (gestion des règles, des utilisateurs, de l\'infogérance pour le support, etc.).\r\n                    </li>\r\n                </ul>\r\n                </p>\r\n            </section>\r\n            <section>\r\n                <h2>Le rôle de PowerShell dans un système de type Windows Server</h2>\r\n                <p>\r\n                    PowerShell est une solution multiplateforme d’automatisation des tâches, composée d’un interpréteur\r\n                    de\r\n                    commandes (shell), d’un langage de script et d’un framework de gestion de la configuration.\r\n                    PowerShell\r\n                    s’exécute sur Windows, Linux et macOS.\r\n                    La nature extensible de PowerShell a permis à un écosystème de modules PowerShell de déployer et de\r\n                    gérer\r\n                    quasiment toutes les technologies comme Windows.\r\n                    PowerShell peut être utilisé pour administrer, maintenir, configurer et développer de nouvelles\r\n                    fonctionnalités pour Windows Server.\r\n                </p>\r\n            </section>\r\n            <section>\r\n                <h2>Schématiser le Système d\'Information à l\'aide d\'un logiciel adapté</h2>\r\n                <p>\r\n                    Le scan de ports réseaux ou balayage de ports est une méthode qui consiste à énumérer les ports\r\n                    ouverts\r\n                    ou\r\n                    actifs d’une cible.\r\n                    Le but est surtout de lister les ports ouverts afin de connaître les applications et services en\r\n                    cours\r\n                    de\r\n                    fonctionnement.\r\n\r\n                    Il existe de multiples applications sur Linux et Windows pour effectuer des balayages de ports\r\n                    réseaux.\r\n                <ul>\r\n                    <li>Advanced IP Scanner pour Windows :\r\n                        Permet d’énumérer très facilement les machines et hôtes d’un réseau LAN.\r\n                        On obtient donc la liste des hôtes avec leurs adresses IP et adresse MAC.</li>\r\n\r\n                    <li>Nmap pour Windows et Linux :\r\n                        Utilitaire le plus connus et renommé qui existe en ligne de commandes ou avec une interface\r\n                        graphique.\r\n                        Nmap\r\n                        propose beaucoup d’options pour scanner un seul port ou encore jouer sur le mode de connexion ou\r\n                        protocole\r\n                        pour contourner des filtrages des firewall.</li>\r\n                </ul>\r\n                </p>\r\n            </section>'),
(35, 20, '_html_code', 'field_633c2d937a94b'),
(36, 20, 'description', 'Cours d\'introduction sur le système d\'information.'),
(37, 20, '_description', 'field_633c433336136'),
(38, 9, '_encloseme', '1'),
(39, 21, 'html_code', '<section>\r\n    <h2>Les différents composants du Système d\'Information</h2>\r\n    <p>\r\n        Un système d’information est l\'ensemble des outils et moyens pour collecter, stocker, traiter et\r\n        traiter\r\n        l\'information. Le SI repose sur un socle :\r\n    <ul>\r\n        <li>technique (gestion de l\'infrastructure et architecture informatique, c\'est-à-dire les serveurs\r\n            pour\r\n            les\r\n            réseaux informatique, les ordinateurs et postes de travail...),</li>\r\n        <li>applicatif (les logiciels informatiques : erp, crm, bases de données, applications web),</li>\r\n        <li>organisationnel (gestion des règles, des utilisateurs, de l\'infogérance pour le support, etc.).\r\n        </li>\r\n    </ul>\r\n    </p>\r\n</section>\r\n<section>\r\n    <h2>Le rôle de PowerShell dans un système de type Windows Server</h2>\r\n    <p>\r\n        PowerShell est une solution multiplateforme d’automatisation des tâches, composée d’un interpréteur\r\n        de\r\n        commandes (shell), d’un langage de script et d’un framework de gestion de la configuration.\r\n        PowerShell\r\n        s’exécute sur Windows, Linux et macOS.\r\n        La nature extensible de PowerShell a permis à un écosystème de modules PowerShell de déployer et de\r\n        gérer\r\n        quasiment toutes les technologies comme Windows.\r\n        PowerShell peut être utilisé pour administrer, maintenir, configurer et développer de nouvelles\r\n        fonctionnalités pour Windows Server.\r\n    </p>\r\n</section>\r\n<section>\r\n    <h2>Schématiser le Système d\'Information à l\'aide d\'un logiciel adapté</h2>\r\n    <p>\r\n        Le scan de ports réseaux ou balayage de ports est une méthode qui consiste à énumérer les ports\r\n        ouverts\r\n        ou\r\n        actifs d’une cible.\r\n        Le but est surtout de lister les ports ouverts afin de connaître les applications et services en\r\n        cours\r\n        de\r\n        fonctionnement.\r\n\r\n        Il existe de multiples applications sur Linux et Windows pour effectuer des balayages de ports\r\n        réseaux.\r\n    <ul>\r\n        <li>Advanced IP Scanner pour Windows :\r\n            Permet d’énumérer très facilement les machines et hôtes d’un réseau LAN.\r\n            On obtient donc la liste des hôtes avec leurs adresses IP et adresse MAC.</li>\r\n\r\n        <li>Nmap pour Windows et Linux :\r\n            Utilitaire le plus connus et renommé qui existe en ligne de commandes ou avec une interface\r\n            graphique.\r\n            Nmap\r\n            propose beaucoup d’options pour scanner un seul port ou encore jouer sur le mode de connexion ou\r\n            protocole\r\n            pour contourner des filtrages des firewall.</li>\r\n    </ul>\r\n    </p>\r\n</section>'),
(40, 21, '_html_code', 'field_633c2d937a94b'),
(41, 21, 'description', 'Cours d\'introduction sur le système d\'information.'),
