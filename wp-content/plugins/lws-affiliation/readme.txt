...
Easily add banners and widgets such as search domain name availability or a summary table of our web hosting plans on your website.
...
You will need a [LWS Affiliation account](https://affiliation.lws-hosting.com/) to use it.

== Installation ==

Upload the LWS Affiliation plugin to your blog, Activate it, then enter your [LWS Affiliation account](https://affiliation.lws-hosting.com/).
