    ...
    <div>
        <div id="parcoursLeft">
            ...
            if (have_posts()) : while (have_posts()) : the_post();
                    echo '<div class="parcours" data-titre-cours="' . get_the_title() . '" data-titre-long="' . get_field("titre_long") . '" data-date-debut="' . get_field("date_debut") . '" data-date-fin="' . get_field("date_fin") . '" data-texte="' . get_field("texte") . '"></div>';
                endwhile;
            endif;
            ?>
        </div>
        <div id="parcoursRight">
            <h2 class="titre"></h2>
            <p class="texte"></p>
        </div>
    </div>
