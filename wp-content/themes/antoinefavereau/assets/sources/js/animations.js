...
if (window.getComputedStyle(document.querySelector("#services .servicesList")).getPropertyValue("flex-direction") == "column") {
    gsap.utils.toArray("#services .servicesList .item").forEach(function (elem) {
        ScrollTrigger.create({
            trigger: elem,
            onEnter: function () {
                gsap.fromTo(
